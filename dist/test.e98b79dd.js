...
var run = function run() {
  if (n <= string.length) {
    //运行代码
    demo.innerHTML = string.substring(0, n); //在页面输出代码

    demo2.innerText = string.substring(0, n); //自动拉滚动条
...
btnFast.onclick = function () {
  ...
  time = 0;
  id = play();
}; // id = setInterval(run,time)=== id = setInterval(() => {
//     run()
// }, time);
...
},{}]},{},["C:/Users/admin/AppData/Local/Yarn/Data/global/node_modules/parcel-bundler/src/builtins/hmr-runtime.js","test.js"], null)
